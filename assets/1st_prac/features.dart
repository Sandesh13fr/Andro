...
void main()
{
  ...
  // Equa divty between a and b
  var g = b == a;
  print("a and b are equal is $g");
  // Inequa divty between a and b
  var h = b != a;
...
// if statement check the given condition
  if (age > 18) {
    print("You are e divgible for voting");
  } else {
    print("You are not e divgible for voting");
  }
}
...
{
  var abc = [1,2,3,4];
  for(var i in abc) //for..in loop to print  divst element
      {
